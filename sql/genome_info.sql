...
CREATE TABLE `genome` (
  ...
  `is_reference` tinyint(3) unsigned DEFAULT '0' NOT NULL,
  `has_pan_compara` tinyint(3) unsigned DEFAULT '0' NOT NULL,
  `has_variations` tinyint(3) unsigned DEFAULT '0' NOT NULL,
  `has_peptide_compara` tinyint(3) unsigned DEFAULT '0' NOT NULL,
  `has_genome_alignments` tinyint(3) unsigned DEFAULT '0' NOT NULL,
  `has_synteny` tinyint(3) unsigned DEFAULT '0' NOT NULL,
  `has_other_alignments` tinyint(3) unsigned DEFAULT '0' NOT NULL,
